...
let recipesData: [Recipe] = [
  Recipe(
    ...
    cooking: 0,
    instructions: [
      "In a small jar, add the olive oil, lemon juice, salt, pepper and the stalks of the parsley. Closed the lid and shake until combined into an almost creamy texture.",
